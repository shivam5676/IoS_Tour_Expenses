    ...
    <div className="w-[250px] h-[81vh]  min-[980px]:w-[300px]  bg-white text-black rounded-2xl my-1 min-[1400px]:my-2 shadow-md shadow-gray-700 font-['Poppins']">
      ...
      <div className="flex flex-col items-center h-[calc(81vh-185px)] justify-between">
        <div className="mt-4 w-[100%] flex flex-col  items-center">
          <p className="font-bold hover:bg-purple-300 w-[60%] my-0 min-[1400px]:my-2  text-center hover:text-white" onClick={()=>navigate("/home")}>
            home
          </p>
          <p className="font-bold hover:bg-purple-300 w-[60%] my-0 min-[1400px]:my-2 text-center hover:text-white" onClick={()=>navigate("/adminUser")}>
            users
          </p>
          <p className="font-bold hover:bg-purple-300 w-[60%] my-0 min-[1400px]:my-2 text-center hover:text-white" onClick={()=>navigate("/adminReport")}>
            reports
          </p>
          <p className="font-bold hover:bg-purple-300 w-[60%] my-0 min-[1400px]:my-2 text-center hover:text-white" onClick={()=>navigate("/adminReport")}>
            change password
